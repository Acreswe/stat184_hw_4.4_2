...
#| echo: false
# Coding Style: Tidyverse Style Guide (https://style.tidyverse.org)
# Load Packages
library(tidyverse)
library(rvest)
library(knitr)
...
#| fig-pos: H
#| fig-alt: "Line plot showing group mean calcium measurements over four time points for two groups, with individual subject trajectories displayed as faint lines in the background."
#| echo: false
...
#| fig-pos: H
#| fig-alt: "Line plot showing only group mean calcium measurements over four time points for two groups, without individual subject trajectories."
#| echo: false
